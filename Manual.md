...
|                           | -manualHoldMarginMassThreshold | kg      | Y        | Sets the maximum total mass at which the hold margin is reduced by 75% to reduce oscillations while in manual control. Default is 3000kg.                                                            |
