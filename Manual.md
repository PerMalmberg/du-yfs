...
* Ensure that there is at least seven meter of clearance from the bottom of the construct to the floor of the space core where the construct is meant to go from space onto the core.
