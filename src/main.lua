...
input:Register(keys.option8, Criteria():OnPress(), function()
    fc:ClearWP()
    fc:AddWaypoint(Waypoint(start - universe:VerticalReferenceVector() * 1800, calc.Kph2Mps(1500), 0.1, alignment.RollTopsideAwayFromNearestBody, alignment.YawPitchKeepOrthogonalToGravity))
